...
```
## Database
A SQL Server database holds information for the objects in the system - Candidates, Exams Centres, Venues within the centre, Session timetables, and results. A partial diagram is shown below. 
